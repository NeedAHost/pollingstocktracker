...
public class HkexSource {

	private static final Logger logger = LoggerFactory.getLogger(HkexSource.class);
	...
	public List<Shareholding> get(String symbol, String year, String month, String date) {
		...
		String postData = String.format(postTemplate, todayDay, todayMonth, todayYear, sessionToken, date, month, year,
				symbolInt);
		// System.out.println("PostData " + postData);

		String resp = HttpUtil.post(baseUrl, postData, cookieAndData[0]);
